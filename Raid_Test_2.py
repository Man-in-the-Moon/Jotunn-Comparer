...
activities_len_1 = len(raid_data_json["Response"][0]['activities']) - 1
activities_len_2 = len(raid_data_json["Response"][1]['activities']) - 1
activities_len_3 = len(raid_data_json["Response"][2]['activities']) - 1
activities_len_4 = len(raid_data_json["Response"][3]['activities']) - 1

if activities_len_1 and activities_len_2 and activities_len_3 and activities_len_4 > 0:
    ...
    for number in range(0, activities_len_3):
        Raid_Name_3 = raid_data_json["Response"][2]["activities"][number]["activityDetails"]["referenceId"]
    for number in range(0, activities_len_4):
        Raid_Name_4 = raid_data_json["Response"][3]["activities"][number]["activityDetails"]["referenceId"]
        print(Raid_Name_1, Raid_Name_2, Raid_Name_3, Raid_Name_4)
elif activities_len_1 and activities_len_2 and activities_len_3 > 0:
    for number in range(0, activities_len_1):
        Raid_Name_1 = raid_data_json["Response"][0]["activities"][number]["activityDetails"]["referenceId"]
    for number in range(0, activities_len_2):
        Raid_Name_2 = raid_data_json["Response"][1]["activities"][number]["activityDetails"]["referenceId"]
    for number in range(0, activities_len_3):
        Raid_Name_3 = raid_data_json["Response"][2]["activities"][number]["activityDetails"]["referenceId"]
        print(Raid_Name_1, Raid_Name_2, Raid_Name_3)
elif activities_len_1 and activities_len_2 > 0:
    for number in range(0, activities_len_1):
        Raid_Name_1 = raid_data_json["Response"][0]["activities"][number]["activityDetails"]["referenceId"]
    for number in range(0, activities_len_2):
        Raid_Name_2 = raid_data_json["Response"][1]["activities"][number]["activityDetails"]["referenceId"]
        print(Raid_Name_1, Raid_Name_2)
elif activities_len_1 > 0:
    for number in range(0, activities_len_1):
        Raid_Name_1 = raid_data_json["Response"][0]["activities"][number]["activityDetails"]["referenceId"]
        print(Raid_Name_1)
